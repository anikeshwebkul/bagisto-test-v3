...
export type BagistoPaymentDataType = {
  cart: {
    ...
    selectedShippingRate: Record<string, unknown>;
    payment: {
      id: string;
      method: string;
      methodTitle: string;
...
export type TranslationsTypes = {
  id: string;
  themeCustomizationId: string | number;
  locale: string;     // API returns "locale" not "localeCode"
  options: string | OptionDataTypes;
};
